...
import {
    FaArrowLeft, FaEdit, FaTrash, FaBan, FaCheck, FaCoins, FaTicketAlt, FaChartLine, FaPhone, FaCalendarAlt, FaGamepad, FaShieldAlt
} from 'react-icons/fa';
...
const UserProfilePage = () => {
    ...
    const [transferSize] = useState(10);
    ...
    const [dailyStatsSize] = useState(10);
                ...
                <div className="card profile-card" style={{ background: '#252a41', borderRadius: '15px', padding: '25px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                    ...
                    <div className="profile-details" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        <div className="detail-item">
                            <label style={{ color: '#888', display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '5px' }}><FaCalendarAlt /> Ro'yxatdan o'tgan</label>
                            <div style={{ color: '#fff', fontWeight: '500' }}>{formatDate(user.registeredAt)}</div>
                        </div>
                        <div className="detail-item">
                            <label style={{ color: '#888', display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '5px' }}><FaGamepad /> Platformalar</label>
